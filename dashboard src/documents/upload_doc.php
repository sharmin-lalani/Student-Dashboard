...
<!-- content starts-->
		<div id="content">
			...
			<div class="post">
             ...
             <form class="box login" style="margin-top:100px; margin-left:-05px; background-color:#378484;" method="post" action="upload_file.php" enctype="multipart/form-data">
             <center><h2 style="color:#eee ">Upload</h2></center>
   <table cellpadding="5px" class="boxBody">
   <tr><td>File Name:</td></tr>
   <tr><td><input type="text" name="filename" /></td></tr>
   <tr><td><input type="hidden" name="MAX_FILE_SIZE" value="50000000" /></td></tr>
