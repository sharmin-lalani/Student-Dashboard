...
<div id="wrapper" >
    ...
    <form class="box login" action="registeruser.php" method="post" name="reg"  style="width: 480px;" enctype="application/x-www-form-urlencoded" onSubmit="return validateForm();">
    <br />
...
<td><input type="text" name="fname" id="tbox" required="required" value="" /></td>
</tr>
<tr>
...
<tr>
<td>Mobile No:</td>
<td><input type="text" name="mobileno" pattern="[0-9]{10}" maxlength="10" id="tbox" value=""/></td>
</tr>

<tr style="margin-bottom:10px">
<td> Select Year:<div id="red">*</div></td>
<td>
<select name="year">
