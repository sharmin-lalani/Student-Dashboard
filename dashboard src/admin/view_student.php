...
<div class="box" style="width:900px; margin-bottom:500px;">
   <br />
     <center><h2 style="color:#066;">Manage Student Accounts</h2></center>
...
<?php
$row = mysql_query("select user_id, fname, lname, verified from user where profession='s' order by fname");
