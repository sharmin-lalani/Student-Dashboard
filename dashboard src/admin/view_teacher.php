...
<div class="box" style="width:900px; margin-bottom:500px;">
   <br />
     <center><h2 style="color:#066;">Manage Teacher Accounts</h2></center>
   ...
   <tr>
        ...
        <th style="font-size:17px;">Verification status</th>
    	<th style="font-size:17px;">Action</th>
   </tr>
<?php
$row = mysql_query("select user_id, fname, lname, verified from user where profession='t' order by fname");
